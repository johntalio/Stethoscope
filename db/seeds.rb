...
ny_doctors_hash["data"].each do |doctor|
  ...
  state: doctor["practices"][0]["visit_address"]["state"], street: doctor["practices"][0]["visit_address"]["street"], zip: doctor["practices"][0]["visit_address"]["zip"], specialty: doctor["specialties"][0]["name"], specialty_info: doctor["specialties"][0]["description"],
  phone_num: doctor["practices"][0]["phones"][0]["number"], phone_type: doctor["practices"][0]["phones"][0]["type"])
end
